...
procedure TCustomer.GetPeople;
var
  lPeople: TObjectList<TPerson>;
begin
  lPeople := TObjectList<TPerson>.Create(True); // True = libera os objetos internos automaticamente
  ...
  Render(lPeople); // NÃO liberar manualmente, DMVC cuida disso
end;
...
//      .Build;
  ...
  try
    ...
    Response.AddPair('firstName', Person.FirstName);
    Response.AddPair('lastName', Person.LastName);
